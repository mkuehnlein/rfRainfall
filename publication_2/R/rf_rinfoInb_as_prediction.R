...
path.in <- "/home/mkuehnlein/casestudies/rf_input/vp_03/inb/as/"
...
file.copy("rf_rinfoInb_as_prediction.Rout", path.out.akt, overwrite = TRUE, copy.mode = TRUE)

}

## copy Rout #####################
file.copy("rf_rinfoInb_as_prediction.Rout", path.out, overwrite = TRUE, copy.mode = TRUE)
file.remove("rf_rinfoInb_as_prediction.Rout")
