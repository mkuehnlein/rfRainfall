...
path.in <- "/home/mkuehnlein/casestudies/rf_input/vp_03/day/as/"
...
file.copy("rf_rinfoDay_as_prediction.Rout", path.out.akt, overwrite = TRUE, copy.mode = TRUE)

}

## copy Rout #####################
file.copy("rf_rinfoDay_as_prediction.Rout", path.out, overwrite = TRUE, copy.mode = TRUE)
file.remove("rf_rinfoDay_as_prediction.Rout")
