...
path.out <- "/home/mkuehnlein/randomForest/rf_rain/results/vp03/rprocess2/inb/as/"
...
file.copy("rf_rainInb_as_prediction.Rout", path.out.akt, overwrite = TRUE, copy.mode = TRUE)

}


## copy Rout #####################
file.copy("rf_rainInb_as_prediction.Rout", path.out, overwrite = TRUE, copy.mode = TRUE)
file.remove("rf_rainInb_as_prediction.Rout")
