...
path.in <- "/home/mkuehnlein/casestudies/rf_input/vp_03/night/as/"
path.out <- "/home/mkuehnlein/randomForest/rf_rinfo/results/vp03/night/"
...
file.copy("rf_rinfoNight_as_prediction.Rout", path.out.akt, overwrite = TRUE, copy.mode = TRUE)

}

## copy Rout #####################
file.copy("rf_rinfoNight_as_prediction.Rout", path.out, overwrite = TRUE, copy.mode = TRUE)
file.remove("rf_rinfoNight_as_prediction.Rout")
