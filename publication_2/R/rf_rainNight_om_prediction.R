...
path.out <- "/home/mkuehnlein/randomForest/rf_rain/results/vp03/rprocess2/night/om/"
...
file.copy("rf_rainNight_om_prediction.Rout", path.out.akt, overwrite = TRUE, copy.mode = TRUE)

}


## copy Rout #####################
file.copy("rf_rainNight_om_prediction.Rout", path.out, overwrite = TRUE, copy.mode = TRUE)
file.remove("rf_rainNight_om_prediction.Rout")
