...
path.in <- "/home/mkuehnlein/casestudies/rf_input/vp_03/inb/om/"
path.out <- "/home/mkuehnlein/randomForest/rf_rinfo/results/vp03/inb/"
...
file.copy("rf_rinfoInb_om_prediction.Rout", path.out.akt, overwrite = TRUE, copy.mode = TRUE)

}

## copy Rout #####################
file.copy("rf_rinfoInb_om_prediction.Rout", path.out, overwrite = TRUE, copy.mode = TRUE)
file.remove("rf_rinfoInb_om_prediction.Rout")
