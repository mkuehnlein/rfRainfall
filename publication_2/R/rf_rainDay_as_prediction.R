...
path.out <- "/home/mkuehnlein/randomForest/rf_rain/results/vp03/rprocess2/day/as/"
...
file.copy("rf_rainDay_as_prediction.Rout", path.out.akt, overwrite = TRUE, copy.mode = TRUE)

}


## copy Rout #####################
file.copy("rf_rainDay_as_prediction.Rout", path.out, overwrite = TRUE, copy.mode = TRUE)
file.remove("rf_rainDay_as_prediction.Rout")
