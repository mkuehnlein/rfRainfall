...
path.in <- "/home/mkuehnlein/casestudies/rf_input/vp_03/night/om/"
...
file.copy("rf_rinfoNight_om_prediction.Rout", path.out.akt, overwrite = TRUE, copy.mode = TRUE)

}

## copy Rout #####################
file.copy("rf_rinfoNight_om_prediction.Rout", path.out, overwrite = TRUE, copy.mode = TRUE)
file.remove("rf_rinfoNight_om_prediction.Rout")
